function phow_imageNet200(conf)
...
conf.calDir = '~/imageNet200/101_ObjectCategories' ;
conf.dataDir = './dataImageNet200' ;
...
conf.prefix = ['imageNet200_' conf.prefix];

conf.vocabPath = fullfile(conf.dataDir, [conf.prefix '-vocab2.mat']) ;
conf.histPath = fullfile(conf.dataDir, [conf.prefix '-hists2.mat']) ;
conf.modelPath = fullfile(conf.dataDir, [conf.prefix '-model2.mat']) ;
conf.resultPath = fullfile(conf.dataDir, [conf.prefix '-result2.mat']) ;
